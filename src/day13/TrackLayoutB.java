...
final class TrackLayoutB {
    ...
    void doTick() {
        ...
        carts.removeIf(Cart::isCollided);
        sortCarts();
    }
    ...
    static TrackLayoutB of(final List<String> lines) {
        final char[][] grid = lines.stream()
                .map(String::toCharArray)
                .toArray(char[][]::new);

        return new TrackLayoutB(grid);
    }
}
